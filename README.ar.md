...
### يحوّل الصورة إلى حكاية شعبية فطرية ذات حبيبات وحياة يومية
...
تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 100 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يختزل **Panel 100** موضوع الصورة وحركتها وعلاقتها في ظلال فطرية وأشكال بدائية ورموز شعبية قليلة. يحتفظ بحبيبات الشمع والباستيل والقلم الخشن، ويعيد تنظيم أكثر ألوان الصورة حيوية في لوحة محدودة ومشرقة.

### مناسب لـ

- اختزال موضوع الصورة وحركتها وعلاقتها مع الحفاظ على القصة؛
- ظلال بدائية ومنظور مسطّح وحبيبات الشمع أو الباستيل أو القلم الخشن؛
- ألوان محدودة مشرقة مشتقة من الأصل ورموز شعبية وفراغ ورقي دافئ؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات؛

### بداية سريعة

> استخدم XXD Panel 100 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** سرد شعبي فطري · أشكال بدائية · منظور مسطح · حبيبات الشمع · ألوان محدودة · حروف تحريرية شعبية
...
|---|---|
| **الناتج** | ملصق تحريري شعبي تعمل فيه الظلال الخشنة والحبيبات اليدوية والسرد اليومي كوحدة واحدة |
| **البصمة الواضحة** | أشكال بدائية، فضاء مسطح، حبيبات شمع، ورق دافئ، لمسات لون قليلة وحروف شعبية |
...
```text
قراءة الموضوع والعلاقة → حذف الخلفية المعقدة → الاختزال إلى ظلال فطرية وأشكال بدائية → إعادة السرد بمنظور مسطح → استخراج ألوان حية قليلة → الإنهاء بحبيبات جافة وحروف شعبية
```

## سمات النتيجة النهائية

- تحافظ الظلال المبسطة والأشكال البدائية الكبيرة على الهوية والعلاقة السردية.
- تبقى في المساحات الداكنة آثار المسح والتراكم والانقطاع وظهور الورق.
- يثبت الورق الدافئ والظلال الداكنة عدداً قليلاً من اللمسات الحية المشتقة من الصورة.
- يدخل النص مثل لافتة أو قائمة أو ملاحظة أو تعليق منشور.
- تجنب رسوم الأطفال والملصقات اللطيفة والواقعية والمتجهات الملساء والمنظور المعقد و3D والقوالب.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-100-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 100. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-100 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-100 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-100 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-100 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-100 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 100 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-100 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-100`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-100-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-100-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

تم تحديث سلسلة XXD Panel الحالية لتشمل 001–112، ويحتفظ كل Panel بموجّهه الأصلي ومنطقه الجمالي المستقل. الجدول أدناه هو الدليل التاريخي حتى وقت إصدار هذا المشروع؛ يسرد 001–100 بصورة متتابعة، ويظهر المشروع الحالي بخط عريض.
