...
예시 영역은 예약되어 있습니다. 검증 가능한 원작 링크나 100 원본 프롬프트와 직접 대조한 확장 예시가 준비되면 이곳에 먼저 표시하며, 다른 번호의 이미지나 깨진 자리표시자로 대신하지 않습니다.
...
- 사진을 단순화하면서 감정과 이야기의 핵심을 지키고 싶을 때
- 원본에서 나온 밝은 색, 손의 불완전함, 넓은 종이 여백이 필요할 때
- 일상의 기억과 문화적 이야기, 부드러운 유머를 그림책처럼 전하고 싶을 때
